-- CreateEnum
CREATE TYPE "AdminChatState" AS ENUM ('NONE', 'REGISTER_USER_IN_WEB_TG', 'REGISTER_USER_IN_WEB_TG_BY_QR_CODE', 'REGISTER_USER_IN_WEB_TG_VERIFY_CODE', 'ADD_CHANEL', 'ADD_CHANEL_CONFIG');
